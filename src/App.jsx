...
export default function GymTracker() {
  ...
  const handleDragEnd = () => {
    if (dragIdx !== null && dragOverIdx !== null && dragIdx !== dragOverIdx) {
      ...
      setExercises(reordered); persist(reordered, null, null);
    }
  ...
  const handleTouchStart = (idx) => {
    longPressTimer.current = setTimeout(() => { setDragIdx(idx); }, 500);
  };
            ...
            return (
              <div key={ex.id}
                ...
                style={{
                  display: "flex", alignItems: "center", padding: "13px 14px",
                  borderBottom: `1px solid ${C.border2}`,
                  background: dragOverIdx === realIdx ? "#1a1a1a" : dragIdx === realIdx ? "#0a0a0a" : "transparent",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                  ...
                  <span style={{ color: C.ghost2, fontSize: 20, padding: "0 4px", cursor: "grab" }}>⠿</span>
                </div>
              </div>
            );
          })}
